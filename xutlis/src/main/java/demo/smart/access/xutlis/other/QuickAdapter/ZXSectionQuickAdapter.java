 ...
 */
public abstract class ZXSectionQuickAdapter<T extends SectionEntity, K extends ZXBaseHolder> extends ZXQuickAdapter<T, K> {
     ...
     */
    public ZXSectionQuickAdapter(int layoutResId, int sectionHeadResId, List<T> data) {
