package demo.smart.access.xutlis.views.BubSeekBar;
 ...
 */
public class ZXSeekBar extends View {
    ...
    public ZXSeekBar(Context context) {
        this(context, null);
    }

    public ZXSeekBar(Context context, AttributeSet attrs) {
        this(context, attrs, 0);
    }

    public ZXSeekBar(Context context, AttributeSet attrs, int defStyleAttr) {
        super(context, attrs, defStyleAttr);

        TypedArray a = context.obtainStyledAttributes(attrs, R.styleable.ZXSeekBar, defStyleAttr, 0);
        mMin = a.getFloat(R.styleable.ZXSeekBar_bsb_min, 0.0f);
        mMax = a.getFloat(R.styleable.ZXSeekBar_bsb_max, 100.0f);
        mProgress = a.getFloat(R.styleable.ZXSeekBar_bsb_progress, mMin);
        isFloatType = a.getBoolean(R.styleable.ZXSeekBar_bsb_is_float_type, false);
        mTrackSize = a.getDimensionPixelSize(R.styleable.ZXSeekBar_bsb_track_size, dp2px(2));
        mSecondTrackSize = a.getDimensionPixelSize(R.styleable.ZXSeekBar_bsb_second_track_size,
                mTrackSize + dp2px(2));
        mThumbRadius = a.getDimensionPixelSize(R.styleable.ZXSeekBar_bsb_thumb_radius,
                mSecondTrackSize + dp2px(2));
        mThumbRadiusOnDragging = a.getDimensionPixelSize(R.styleable.ZXSeekBar_bsb_thumb_radius_on_dragging,
                mSecondTrackSize * 2);
        ...
        mSectionTextColor = a.getColor(R.styleable.ZXSeekBar_bsb_section_text_color, mTrackColor);
        isSeekStepSection = a.getBoolean(R.styleable.ZXSeekBar_bsb_seek_step_section, false);
        isSeekBySection = a.getBoolean(R.styleable.ZXSeekBar_bsb_seek_by_section, false);
        int pos = a.getInteger(R.styleable.ZXSeekBar_bsb_section_text_position, NONE);
        if (pos == 0) {
        ...
        mSectionTextInterval = a.getInteger(R.styleable.ZXSeekBar_bsb_section_text_interval, 1);
        isShowThumbText = a.getBoolean(R.styleable.ZXSeekBar_bsb_show_thumb_text, false);
        mThumbTextSize = a.getDimensionPixelSize(R.styleable.ZXSeekBar_bsb_thumb_text_size, sp2px(14));
        mThumbTextColor = a.getColor(R.styleable.ZXSeekBar_bsb_thumb_text_color, mSecondTrackColor);
        mBubbleColor = a.getColor(R.styleable.ZXSeekBar_bsb_bubble_color, mSecondTrackColor);
        mBubbleTextSize = a.getDimensionPixelSize(R.styleable.ZXSeekBar_bsb_bubble_text_size, sp2px(14));
        mBubbleTextColor = a.getColor(R.styleable.ZXSeekBar_bsb_bubble_text_color, Color.WHITE);
        isShowSectionMark = a.getBoolean(R.styleable.ZXSeekBar_bsb_show_section_mark, false);
        isAutoAdjustSectionMark = a.getBoolean(R.styleable.ZXSeekBar_bsb_auto_adjust_section_mark, false);
        isShowProgressInFloat = a.getBoolean(R.styleable.ZXSeekBar_bsb_show_progress_in_float, false);
        int duration = a.getInteger(R.styleable.ZXSeekBar_bsb_anim_duration, -1);
        mAnimDuration = duration < 0 ? 200 : duration;
        isTouchToSeek = a.getBoolean(R.styleable.ZXSeekBar_bsb_touch_to_seek, false);
        isAlwaysShowBubble = a.getBoolean(R.styleable.ZXSeekBar_bsb_always_show_bubble, false);
        duration = a.getInteger(R.styleable.ZXSeekBar_bsb_always_show_bubble_delay, 0);
        mAlwaysShowBubbleDelay = duration < 0 ? 0 : duration;
        isHideBubble = a.getBoolean(R.styleable.ZXSeekBar_bsb_hide_bubble, false);
        isRtl = a.getBoolean(R.styleable.ZXSeekBar_bsb_rtl, false);
        setEnabled(a.getBoolean(R.styleable.ZXSeekBar_android_enabled, isEnabled()));
        a.recycle();
    ...
    private void autoAdjustSection() {
        ...
        if (!onSection) {
            ...
            valueAnim.addUpdateListener(new ValueAnimator.AnimatorUpdateListener() {
                ...
                public void onAnimationUpdate(ValueAnimator animation) {
                    ...
                    if (mProgressListener != null) {
                        mProgressListener.onProgressChanged(ZXSeekBar.this, getProgress(),
        ...
        animatorSet.addListener(new AnimatorListenerAdapter() {
            ...
            public void onAnimationEnd(Animator animation) {
                ...
                if (mProgressListener != null) {
                    mProgressListener.getProgressOnFinally(ZXSeekBar.this, getProgress(),
                            getProgressFloat(), true);
                }
            }
    ...
    public interface OnProgressChangedListener {
        ...
        void onProgressChanged(ZXSeekBar bubbleSeekBar, int progress, float progressFloat, boolean fromUser);

        void getProgressOnActionUp(ZXSeekBar bubbleSeekBar, int progress, float progressFloat);

        void getProgressOnFinally(ZXSeekBar bubbleSeekBar, int progress, float progressFloat, boolean fromUser);
    }
