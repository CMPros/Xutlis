 ...
 */
public class ZXShadowLayout extends FrameLayout {
    ...
    public ZXShadowLayout(final Context context) {
        this(context, null);
    }

    public ZXShadowLayout(final Context context, final AttributeSet attrs) {
        this(context, attrs, 0);
    }

    public ZXShadowLayout(final Context context, final AttributeSet attrs, final int defStyleAttr) {
