...
public class ZXPhotoView extends android.support.v7.widget.AppCompatImageView  {
    ...
    public boolean canScrollHorizontally(int direction) {
        if (mPinchMode == ZXPhotoView.PINCH_MODE_SCALE) {
            return true;
        }
    ...
    public interface OuterMatrixChangedListener {
         ...
         */
        void onOuterMatrixChanged(ZXPhotoView PhotoView);
    }
    ...
    public ZXPhotoView(Context context) {
        super(context);
        initView();
    }

    public ZXPhotoView(Context context, AttributeSet attrs) {
        super(context, attrs);
        initView();
    }

    public ZXPhotoView(Context context, AttributeSet attrs, int defStyle) {
     ...
     * 在onTouchEvent末尾被执行.
     */
    private GestureDetector mGestureDetector = new GestureDetector(ZXPhotoView.this.getContext(), new GestureDetector.SimpleOnGestureListener() {
        ...
        public void onLongPress(MotionEvent e) {
            ...
            if (mOnLongClickListener != null) {
                mOnLongClickListener.onLongClick(ZXPhotoView.this);
            }
        }
        ...
        public boolean onSingleTapConfirmed(MotionEvent e) {
            ...
            if (mOnClickListener != null) {
                mOnClickListener.onClick(ZXPhotoView.this);
            }
            return true;
        }
    });
