package demo.smart.access.xutlis.other.QuickAdapter.callback;
...
public class ItemDragAndSwipeCallback extends ItemTouchHelper.Callback {
    ...
    private ZXItemDraggableAdapter mBaseItemDraggableAdapter;
    ...
    public ItemDragAndSwipeCallback(ZXItemDraggableAdapter adapter) {
    ...
    private boolean isViewCreateByAdapter(@NonNull RecyclerView.ViewHolder viewHolder) {
        ...
        return type == ZXQuickAdapter.HEADER_VIEW || type == ZXQuickAdapter.LOADING_VIEW
                || type == ZXQuickAdapter.FOOTER_VIEW || type == ZXQuickAdapter.EMPTY_VIEW;
    }
}
