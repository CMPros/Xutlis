...
public class ZXNetworkUtil {
    ...
    private static NetworkInfo getActiveNetworkInfo() {
        return ((ConnectivityManager) ZXApp.getContext().getSystemService(Context.CONNECTIVITY_SERVICE)).getActiveNetworkInfo();
    }
    ...
    public static boolean isWifiConnected() {
        ConnectivityManager cm = (ConnectivityManager) ZXApp.getContext()
