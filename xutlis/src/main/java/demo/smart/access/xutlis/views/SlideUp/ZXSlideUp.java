...
public class ZXSlideUp implements View.OnTouchListener, ValueAnimator.AnimatorUpdateListener, Animator.AnimatorListener, LoggerNotifier {
    ...
    final static String KEY_STAY_AREA = TAG + "_stay_area";
    ...
    ZXSlideUp(ZXSlideUpBuilder builder) {
        mBuilder = builder;
        init();
    }
    ...
    /**
     * <p>Add Listener which will be used in combination with this ZXSlideUp</p>
     */
    ...
    /**
     * <p>Remove Listener which was used in combination with this ZXSlideUp</p>
     */
    ...
    /**
     * <p>Returns gravity which used in combination with this ZXSlideUp</p>
     */
    @StartVector
    ...
    /**
     * <p>Saving current parameters of ZXSlideUp</p>
     */
    public void onSaveInstanceState(@NonNull Bundle savedState) {
        ...
        savedState.putFloat(KEY_STAY_AREA, mBuilder.mStayArea / mBuilder.mDensity);
    ...
    private void show(boolean immediately) {
        ...
        switch (mBuilder.mStartGravity) {
            case TOP:
                if (immediately) {
                    if (mBuilder.mSliderView.getHeight() > mBuilder.mStayArea) {
