...
public abstract class LoadMoreView {
    ...
    public void convert(ZXBaseHolder holder) {
    ...
    private void visibleLoading(ZXBaseHolder holder, boolean visible) {
        holder.setGone(getLoadingViewId(), visible);
    }

    private void visibleLoadFail(ZXBaseHolder holder, boolean visible) {
        holder.setGone(getLoadFailViewId(), visible);
    }

    private void visibleLoadEnd(ZXBaseHolder holder, boolean visible) {
