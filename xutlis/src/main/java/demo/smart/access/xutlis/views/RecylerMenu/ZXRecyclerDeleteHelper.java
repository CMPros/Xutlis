...
public class ZXRecyclerDeleteHelper implements RecyclerView.OnItemTouchListener, OnActivityTouchListener {
    ...
    Runnable mLongPressed = new Runnable() {
        public void run() {
            ...
            if (!bgVisible && touchedPosition >= 0 && !unClickableRows.contains(touchedPosition) && !isRViewScrolling) {
                ...
                mRowLongClickListener.onItemLongClicked(touchedPosition);
            }
        }
    };
    ...
    public ZXRecyclerDeleteHelper(Activity a, RecyclerView recyclerView) {
        this.act = a;
...
//        mSwipeListener = listener;
        ...
        rView.addOnScrollListener(new RecyclerView.OnScrollListener() {
            ...
            public void onScrollStateChanged(RecyclerView recyclerView, int newState) {
                /**
                 * This will ensure that this ZXRecyclerDeleteHelper is paused during recycler view scrolling.
    ...
    public ZXRecyclerDeleteHelper setClickable(OnItemClickListener listener) {
        this.clickable = true;
        this.mRowClickListener = listener;
        return this;
    }

    public ZXRecyclerDeleteHelper setClickable(boolean clickable) {
        this.clickable = clickable;
        return this;
    }

    public ZXRecyclerDeleteHelper setLongClickable(boolean vibrate, OnItemLongClickListener listener) {
    ...
    public ZXRecyclerDeleteHelper setLongClickable(boolean longClickable) {
        this.longClickable = longClickable;
        return this;
    }

    public ZXRecyclerDeleteHelper setIndependentViews(Integer... viewIds) {
        this.independentViews = new ArrayList<>(Arrays.asList(viewIds));
        return this;
    }

    public ZXRecyclerDeleteHelper setUnClickableRows(Integer... rows) {
        this.unClickableRows = new ArrayList<>(Arrays.asList(rows));
        return this;
    }

    public ZXRecyclerDeleteHelper setIgnoredViewTypes(Integer... viewTypes) {
    ...
    public ZXRecyclerDeleteHelper setSwipeable(int foregroundID, int backgroundID, OnSwipeOptionsClickListener listener) {
        this.swipeable = true;
    ...
    /*public ZXRecyclerDeleteHelper setLeftToRightSwipeable(int foregroundID, int backgroundID, OnSwipeOptionsClickListener listener) {
    ...
    public ZXRecyclerDeleteHelper setSwipeOptionViews(Integer... viewIds) {
        this.optionViews = new ArrayList<>(Arrays.asList(viewIds));
        return this;
    }

    public ZXRecyclerDeleteHelper setUnSwipeableRows(Integer... rows) {
    ...
    public ZXRecyclerDeleteHelper setViewsToFade(Integer... viewIds) {
...
//                float absVelocityY = Math.abs(mVelocityTracker.getYVelocity());
                ...
                // if clicked
                    ...
                    // On Click listener for rows
                        ...
                        mRowClickListener.onItemClicked(touchedPosition);
                    }
