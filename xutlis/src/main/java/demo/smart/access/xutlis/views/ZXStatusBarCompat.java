 ...
 * 透明状态栏
 */
public class ZXStatusBarCompat {
    ...
    public static void translucent(Activity activity, @ColorInt int colorOn5x) {
        ...
        // 小米和魅族4.4 以上版本支持沉浸式
        if (ZXDeviceUtil.isMeizu() || ZXDeviceUtil.isMIUI()) {
...
//            }
    ...
    private static boolean isMIUICustomStatusBarLightModeImpl() {
        return ZXDeviceUtil.isMIUIV5() || ZXDeviceUtil.isMIUIV6() ||
                ZXDeviceUtil.isMIUIV7() || ZXDeviceUtil.isMIUIV8();
    }
    ...
    public static boolean supportTransclentStatusBar6() {
        return !(ZXDeviceUtil.isZUKZ1() || ZXDeviceUtil.isZTKC2016());
    }
    ...
    private static void initStatusBarHeight() {
        ...
        if (ZXDeviceUtil.isTablet()
                && sStatusbarHeight > ZXSystemUtil.dp2px(STATUS_BAR_DEFAULT_HEIGHT_DP)) {
            //状态栏高度大于25dp的平板，状态栏通常在下方
            sStatusbarHeight = 0;
        } else {
            if (sStatusbarHeight <= 0
                    || sStatusbarHeight > ZXSystemUtil.dp2px(STATUS_BAR_DEFAULT_HEIGHT_DP * 2)) {
