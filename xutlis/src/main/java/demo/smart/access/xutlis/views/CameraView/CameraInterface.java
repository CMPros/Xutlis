...
public class CameraInterface implements Camera.PreviewCallback {
    ...
    private CameraListener errorLisenter;
    ...
    //视频质量
    private int mediaQuality = ZXCameraView.MEDIA_QUALITY_MIDDLE;
...
//        }
        ...
        if (ZXDeviceUtil.isHuaWeiRongyao()) {
        ...
        try {
            ...
            if (this.errorLisenter != null) {
                this.errorLisenter.onError(CameraListener.ErrorType.RecordIllegalStateError);
            }
        } catch (IOException e) {
            e.printStackTrace();
            Log.i("CJT", "startRecord IOException");
            if (this.errorLisenter != null) {
                this.errorLisenter.onError(CameraListener.ErrorType.RecordIOError);
            }
    ...
    public void stopRecord(boolean isShort, StopRecordCallback callback) {
        ...
        if (mediaRecorder != null) {
            ...
            if (isShort) {
                if (ZXFileUtil.deleteFiles(videoFileAbsPath)) {
    ...
    void setErrorLinsenter(CameraListener errorLisenter) {
