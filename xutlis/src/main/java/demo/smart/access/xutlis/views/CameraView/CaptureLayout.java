...
public class CaptureLayout extends FrameLayout {
    ...
    private BtnClickListener leftClickListener;    //左边按钮监听
    private BtnClickListener rightClickListener;   //右边按钮监听
...
//            btn_album.setVisibility(VISIBLE);
    ...
    public void setLeftClickListener(BtnClickListener leftClickListener) {
        this.leftClickListener = leftClickListener;
    }

    public void setRightClickListener(BtnClickListener rightClickListener) {
